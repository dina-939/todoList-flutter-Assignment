...
Widget buildTodoItem(BuildContext context,String title, {Function()? press,Color? color}) {
  return GestureDetector(
      child: Stack(
       ...
       Card(margin:const EdgeInsets.only(top:15.0,bottom:0,left:20,right:20),
        child: ListTile(trailing: IconButton(icon: Icon(Icons.delete),
          onPressed:press,),
          title: Text('Meeting with client',style: TextStyle(fontSize: 16,color: Color(0xff1321E0)) ),subtitle: Text(title),)),
      ]),
      onTap: (){
      // go to edit page
